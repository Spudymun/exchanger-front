...
## 🚨 НОВОЕ: Проверка технического долга

### Автоматические напоминания при коммите

При каждом коммите теперь запускаются **два критических напоминания**:

1. **📋 Чек-лист задач** (`scripts/checklist-reminder.mjs`)
   - Напоминает обновить CHECKLIST.md файлы
   - Задержка 3 секунды

2. **🚨 Технический долг** (`scripts/tech-debt-reminder.mjs`) - **НОВОЕ**
   - Критическое напоминание о Правиле 13
   - Показывает команды для проверки техдолга
   - Задержка 5 секунд

### Проверка технического долга

Проверка технического долга выполняется автоматически через pre-commit хук с помощью скрипта `scripts/tech-debt-reminder.mjs`.

**Автоматически ищет:**

- ❌ Хардкод (URL, пароли, API ключи)
- ❌ Архитектурные нарушения
- ❌ Проблемы безопасности (XSS, eval)
- ❌ Проблемы производительности
- ❌ Магические числа

### Правило 13: Код без технического долга

> **Задача завершена ТОЛЬКО когда нет технического долга!**

**❌ Недопустимо:**

- Маркеры TODO/FIXME/HACK/TEMP/XXX
- @ts-ignore и any без обоснования
- Hardcode данных и временные решения
...
- Pre-commit проверка техдолга - без проблем
