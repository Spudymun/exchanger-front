...
- **Архитектурные**: 2 нарушения (1 исправлено ✅)
- **Избыточность кода**: 2 нарушения
...
#### ❌ НАРУШЕНИЕ 1.2: Нарушение принципа единой ответственности
...
**Решение по DEVELOPER_GUIDE.md**: Разделить на бизнес-хук (data) и UI-хук (конфигурацию)
...
#### ❌ НАРУШЕНИЕ 3.1: Дублирование логики статусов

**Файл**: `apps/web/src/components/OrderStatus.tsx:28-37`
...
### ✅ ИСПРАВЛЕННЫЕ НАРУШЕНИЯ (1 из 21)
...
**Прогресс**: 4.8% (1/21)
**Критические исправления**: 8.3% (1/12)

### 🔄 В РАБОТЕ

- Переход к следующему нарушению согласно приоритету

### ❌ ОЖИДАЮТ ИСПРАВЛЕНИЯ (20 из 21)
