...
| Стилизация         | **Tailwind CSS + Design System v2.1** | Всегда                      |
| Темизация          | **CSS Variables + Adaptive Classes**  | Смена тем с адаптивностью   |

**📋 Чек-лист UI (обновлен для v2.1):**
...
- [ ] Использовать централизованные стили? → Импортировать из `form-patterns.js`
- [ ] Нужна ли адаптивная темизация? → Использовать `dark:` префиксы + CSS Variables
- [ ] Проверить визуальную иерархию? → Тестировать в обеих темах

**🎨 Дизайн-система v2.1 - Быстрые паттерны:**

```typescript
// Импорт централизованных стилей
import { DESIGN_SYSTEM_V2_1 as DS } from '@repo/ui/styles/form-patterns';
...
<div className={cn(
  ...
  DS.elevation.card,
  DS.borders.default,
  'shadow-blue-500/10 dark:shadow-blue-400/20' // Цветная тень
)}>
