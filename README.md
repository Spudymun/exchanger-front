...
- Подробности: `docs/AUTH_MIGRATION_COMPLETION_REPORT.md` и `docs/план-исправлений-web.md`
...
- **[🚨 Validation & Localization Guide](docs/VALIDATION_LOCALIZATION_GUIDE.md)** - **КРИТИЧЕСКИ ВАЖНО** Исчерпывающее руководство по валидации с локализацией. ОБЯЗАТЕЛЬНО читать перед созданием форм!

### 🔒 Безопасность и валидация

- **[🛡️ Security-Enhanced Validation Schemas](docs/SECURITY_ENHANCED_VALIDATION_GUIDE.md)** - **ОБЯЗАТЕЛЬНО** Руководство по использованию security-enhanced validation schemas с XSS protection
- **[⚡ Validation Architecture Guide](docs/VALIDATION_ARCHITECTURE_GUIDE.md)** - архитектурные принципы системы валидации проекта
