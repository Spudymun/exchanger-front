...
/**
 * Сервис генерации контента Markdown
 */
...
`;
  ...
  /**
   * Создание overview Markdown для страницы
   */
...
`;
  ...
  /**
   * Создание overview Markdown для layout
   */
...
`;
  ...
  /**
   * Извлечение имени проекта и страницы из пути (дублирует логику для совместимости)
   */
