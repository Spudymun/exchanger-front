...
const FontFamiliesSection = ({ fontFamily }: { fontFamily: Record<string, string[]> }) => (
  <section className="mb-12">
    <h2 className="text-2xl font-semibold mb-6 text-gray-900 dark:text-gray-100">Font Families</h2>

    <div className="space-y-6">
      {Object.entries(fontFamily).map(([name, fonts]) => (
        <div key={name} className="border border-gray-200 dark:border-gray-700 rounded-lg p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 capitalize">
              {name}
            </h3>
            <span className="text-sm text-gray-500 dark:text-gray-400 font-mono">font-{name}</span>
          </div>

          <div
            className="text-2xl mb-4 text-gray-900 dark:text-gray-100"
...
const FontSizesSection = ({ fontSize }: { fontSize: Record<string, unknown> }) => (
  <section className="mb-12">
    <h2 className="text-2xl font-semibold mb-6 text-gray-900 dark:text-gray-100">Font Sizes</h2>

    <div className="space-y-4">
      {Object.entries(fontSize).map(([size, value]) => (
        <div key={size} className="flex items-center space-x-6 py-3">
          <div className="w-16 text-sm text-gray-500 dark:text-gray-400 font-mono">{size}</div>
          ...
          <div className="text-sm text-gray-500 dark:text-gray-400 font-mono w-20">
  ...
  <section>
    ...
    <div className="space-y-8">
      ...
      <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-6">
        <h3 className="text-lg font-medium mb-4 text-gray-900 dark:text-gray-100">Headings</h3>
        <div className="space-y-4">
      ...
      {/* Body Text */}
      <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-6">
        <h3 className="text-lg font-medium mb-4 text-gray-900 dark:text-gray-100">Body Text</h3>
        <div className="space-y-4">
