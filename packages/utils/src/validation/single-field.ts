 ...
 */
export function validateSingleEmail(value: string, config: NextIntlValidationConfig): { isValid: boolean; error: string | null } {
 ...
 */
export function validateSinglePassword(value: string, config: NextIntlValidationConfig): { isValid: boolean; error: string | null } {
 ...
 */
export function validateSingleConfirmPassword(value: string, passwordValue: string, config: NextIntlValidationConfig): { isValid: boolean; error: string | null } {
    if (!value || value.trim() === '') {
 ...
 */
export function validateSingleCaptcha(value: string, config: NextIntlValidationConfig): { isValid: boolean; error: string | null } {
