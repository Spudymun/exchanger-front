...
export const VALIDATION_KEYS = {
  ...
  CONFIRM_NEW_PASSWORD_REQUIRED: 'validation.confirmNewPassword.required',
  CONFIRM_NEW_PASSWORD_NO_MATCH: 'validation.confirmNewPassword.noMatch',
  RESET_CODE_REQUIRED: 'validation.resetCode.required',
