...
│   │   ├── useAuth.ts             # ⚠️ DEPRECATED
│   │   └── useForm.ts             # ⚠️ DEPRECATED
│   └── ui/                        # UI хуки
...
| --------------------- | ------------- | ----------------------------------- |
| `business/useAuth.ts` | ⚠️ DEPRECATED | Используйте локализованные переводы |
| `business/useForm.ts` | ⚠️ DEPRECATED | Используйте useFormWithNextIntl     |
...
### От useForm к useFormWithNextIntl
...
### От useAuth к локализованным переводам
...
- Используйте `useFormWithNextIntl` для новых форм
...
- Не используйте deprecated хуки (`useAuth`, `useForm`)
