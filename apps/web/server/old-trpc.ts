/* eslint-disable */
// Old tRPC implementation - will be removed after Part-2 completion
...
export const appRouter = router({
  ...
  portfolio: router({
    ...
    getBalance: publicProcedure.input(z.string()).query(({ input }) => {
  ...
  market: router({
    ...
    getPair: publicProcedure.input(CurrencyPairSchema).query(({ input }) => ({
      pair: input,
