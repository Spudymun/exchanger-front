...
**Generated**: 2025-07-24T15:00:26.440Z
...
- **SendingCard**: bg-card, border-l-4, border-l-blue-500, dark:border-l-blue-400, dark:shadow-blue-400/20, duration-200, gap-4, grid, grid-cols-1, hover:shadow-lg, shadow-blue-500/15, shadow-md, sm:grid-cols-2, space-y-4, text-card-foreground, text-foreground, transition-all
